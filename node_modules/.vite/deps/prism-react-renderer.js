import { r as __toESM$1 } from "./rolldown-runtime-DC62tzP2.js";
...
var useGetLineProps = (themeDictionary) => (0, import_react.useCallback)((_a) => {
...
var useGetTokenProps = (themeDictionary) => {
	const styleForToken = (0, import_react.useCallback)(({ types, empty }) => {
	...
	return (0, import_react.useCallback)((_a) => {
...
*/
//#endregion
export { Highlight2 as Highlight, Prism, normalizeTokens_default as normalizeTokens, themes_exports as themes, useTokenize };
