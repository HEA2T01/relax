import { $ as CanvasTexture, Br as LoadingManager, Ds as Vector3, Es as Vector2, Fr as LinearSRGBColorSpace, Gr as Material, Gt as DepthStencilFormat, I as BasicDepthPacking, Is as WebGLRenderTarget, It as Data3DTexture, K as BufferAttribute, Kt as DepthTexture, Nr as LinearMipmapLinearFilter, Os as Vector4, Qr as Mesh, Rr as Loader, Rt as DataTexture, Ui as OrthographicCamera, Xr as Matrix4, Ya as RGFormat, Zo as Texture, _s as UnsignedByteType, ei as MeshDepthMaterial, fn as EventDispatcher, fo as SRGBColorSpace, ha as RGBAFormat, hn as FileLoader, ho as ShaderMaterial, ii as MeshNormalMaterial, it as ClampToEdgeWrapping, kr as LinearFilter, ma as RGBADepthPacking, mi as NearestFilter, mo as Scene, ms as Uniform, oo as RepeatWrapping, ot as Color, q as BufferGeometry, qi as PerspectiveCamera, to as RedFormat, vn as FloatType, ys as UnsignedInt248Type } from "./three.module-CKBt31jn.js";
...
function getCoefficients(n) {
	let result;
	if (n === 0) result = /* @__PURE__ */ new Float64Array(0);
	...
	*/
	constructor(colorOutput = false, luminanceRange = null) {
		super({
			...
			defines: { THREE_REVISION: "180".replace(/\D+/g, "") },
			uniforms: {
				inputBuffer: new Uniform(null),
...
var GlitchEffect = class extends Effect {
	...
	*/
	update(renderer, inputBuffer, deltaTime) {
		...
		if (offset !== null) {
			if (active) offset.set(Math.cos(a), Math.sin(a)).multiplyScalar(r);
			else offset.set(0, 0);
		}
	...
	*/
	constructor(texelSize = new Vector2(), mode = EdgeDetectionMode.COLOR) {
		super({
			...
			defines: {
				THREE_REVISION: "180".replace(/\D+/g, ""),
...
var SSAOEffect = class extends Effect {
	...
	*/
	...
	set color(value) {
		...
		const defines = this.defines;
		if (value !== null) {
			if (defines.has("COLORIZE")) uniforms.get("color").value.set(value);
			else {
...
var TextureEffect = class extends Effect {
	...
	*/
	...
	set uvTransform(value) {
		if (this.texture !== null) this.texture.matrixAutoUpdate = value;
	}
	/**
	...
	*/
	update(renderer, inputBuffer, deltaTime) {
		...
		if (texture !== null && texture.matrixAutoUpdate) texture.updateMatrix();
	}
};
...
var ToneMappingEffect = class extends Effect {
	...
	*/
	...
	set mode(value) {
		...
		const cineonToneMapping = "180".replace(/\D+/g, "") >= 168 ? "CineonToneMapping(texel)" : "OptimizedCineonToneMapping(texel)";
		this.defines.clear();
		...
		switch (value) {
			...
			case ToneMappingMode.NEUTRAL:
				...
				break;
			default: this.defines.set("toneMapping(texel)", "texel");
		}
...
var threeRevision = Number("180".replace(/\D+/g, ""));
...
var P = [/* @__PURE__ */ new Float32Array(3), /* @__PURE__ */ new Float32Array(3)];
var C = [
	/* @__PURE__ */ new Float32Array(3),
	/* @__PURE__ */ new Float32Array(3),
	/* @__PURE__ */ new Float32Array(3),
	/* @__PURE__ */ new Float32Array(3)
];
...
var TetrahedralUpscaler = class {
	...
	*/
	static expand(data, size) {
		...
		const rgb = /* @__PURE__ */ new Float32Array(3);
...
var area = [/* @__PURE__ */ new Float32Array(2), /* @__PURE__ */ new Float32Array(2)];
...
function generatePatterns(patterns, offset, orthogonal) {
	const result = /* @__PURE__ */ new Float32Array(2);
...
var SMAASearchImageData = class {
	...
	*/
	static generate() {
		...
		const data = /* @__PURE__ */ new Uint8ClampedArray(2178);
		const croppedData = /* @__PURE__ */ new Uint8ClampedArray(4096);
		...
		for (let i = 0, y = 17; y < height; ++y) for (let x = 0; x < croppedWidth; ++x, i += 4) {
